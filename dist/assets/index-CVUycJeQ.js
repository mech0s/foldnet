...
`)+`
`+m);const v=y+p+o,_=y+m+a,T=ka(i,i.VERTEX_SHADER,v),S=ka(i,i.FRAGMENT_SHADER,_);i.attachShader(A,T),i.attachShader(A,S),e.index0AttributeName!==void 0?i.bindAttribLocation(A,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(A,0,"position"),i.linkProgram(A);function w(R){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(A).trim(),L=i.getShaderInfoLog(T).trim(),V=i.getShaderInfoLog(S).trim();let k=!0,H=!0;if(i.getProgramParameter(A,i.LINK_STATUS)===!1)if(k=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,A,T,S);else{const z=Va(i,T,"vertex"),U=Va(i,S,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(A,i.VALIDATE_STATUS)+`
