...
`)+`
`+m);const x=v+p+o,_=v+m+a,T=ka(i,i.VERTEX_SHADER,x),b=ka(i,i.FRAGMENT_SHADER,_);i.attachShader(A,T),i.attachShader(A,b),t.index0AttributeName!==void 0?i.bindAttribLocation(A,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(A,0,"position"),i.linkProgram(A);function w(R){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(A).trim(),N=i.getShaderInfoLog(T).trim(),W=i.getShaderInfoLog(b).trim();let V=!0,X=!0;if(i.getProgramParameter(A,i.LINK_STATUS)===!1)if(V=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,A,T,b);else{const z=Va(i,T,"vertex"),B=Va(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(A,i.VALIDATE_STATUS)+`
